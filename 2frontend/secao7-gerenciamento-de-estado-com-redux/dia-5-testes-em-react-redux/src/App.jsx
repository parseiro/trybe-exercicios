...
function App({ countState, dispatch }) {
  const minusButton = (
    <AccessibleIcon.Root label="Diminuir número">
  ...
  const plusButton = <button type="button" className="botao" onClick={() => dispatch(actionCreator(1))}>
    <svg
      aria-hidden="true"
      className="w-4 h-4"
      fill="currentColor"
  ...
  return (
    <div className="flex container items-center justify-center gap-x-4">
      {minusButton}
      {countState}
      {plusButton}
    </div>
